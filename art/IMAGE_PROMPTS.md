...
> Magical-realist portrait of an ordinary neighborhood under an impossible emotional weather: grounded human faces, tactile walls and worn objects, restrained painterly edges, warm sodium light against indigo shadow, and one lucid metaphor that physically embodies the subject’s Burden, shortcoming, or downfall. The impossible element must feel as matter-of-fact as a bus stop or a kitchen sink — intimate, specific, and consequential, never generic fantasy or glossy superhero spectacle. No text, letters, logos, captions, speech balloons, borders, panels, watermarks, or gore. One unified full-bleed image, never a grid, montage, triptych, card frame, or repeated subject.
...
- Burden Realist: `art/images/burden/heroes/the-nightwatch--front.png`, `art/images/burden/heroes/the-nightwatch--turned.png`
...
- Burden Realist: `art/images/burden/heroes/powerline--front.png`, `art/images/burden/heroes/powerline--turned.png`
...
- Burden Realist: `art/images/burden/heroes/kid-chorus--front.png`, `art/images/burden/heroes/kid-chorus--turned.png`
...
- Burden Realist: `art/images/burden/heroes/the-concierge--front.png`, `art/images/burden/heroes/the-concierge--turned.png`
...
- Burden Realist: `art/images/burden/heroes/widows-peak--front.png`, `art/images/burden/heroes/widows-peak--turned.png`
...
- Burden Realist: `art/images/burden/heroes/the-understudy--front.png`, `art/images/burden/heroes/the-understudy--turned.png`
...
- Burden Realist: `art/images/burden/heroes/backline--front.png`, `art/images/burden/heroes/backline--turned.png`
...
- Burden Realist: `art/images/burden/heroes/the-ref--front.png`, `art/images/burden/heroes/the-ref--turned.png`
...
- Burden Realist: `art/images/burden/heroes/palisade--front.png`, `art/images/burden/heroes/palisade--turned.png`
...
- Burden Realist: `art/images/burden/heroes/secondhand--front.png`, `art/images/burden/heroes/secondhand--turned.png`
...
- Burden Realist: `art/images/burden/heroes/rook--front.png`, `art/images/burden/heroes/rook--turned.png`
...
- Burden Realist: `art/images/burden/heroes/switchboard--front.png`, `art/images/burden/heroes/switchboard--turned.png`

## Cases (16 images)

### The Toll

Ferrous Avenue at night beneath an El overpass, small storefronts shuttered one by one while three battered amusement-pier mascot figures — fox, rabbit, and one-eyed bear — collect envelopes under a flickering bakery sign with no readable lettering.

Save as `art/images/ink/cases/toll.png` and `art/images/burden/cases/toll.png`.

### Open Casting

A spectacular new masked vigilante posing atop a wrecked car for phone cameras and television lights, adoring onlookers below while an injured petty criminal lies unnoticed at the edge of the frame.

Save as `art/images/ink/cases/casting.png` and `art/images/burden/cases/casting.png`.

### The Renovation

A lived-in brick block cut sharply in half by spotless luxury construction completed overnight, family belongings abandoned at the seam, a smiling councilwoman’s billboard present only as a faceless graphic with no readable text.

Save as `art/images/ink/cases/renovation.png` and `art/images/burden/cases/renovation.png`.

### Last Call

The interior of a worn neighborhood dive bar at last call, stools and old photographs untouched while the first punch in thirty years hangs suspended above the counter and the silent bartender watches.

Save as `art/images/ink/cases/lastcall.png` and `art/images/burden/cases/lastcall.png`.

### After Hours

A cramped night clinic under a failing fluorescent sign, nurses moving between tired patients while one locked medicine cabinet stands open and a private security car waits outside.

Save as `art/images/ink/cases/afterhours.png` and `art/images/burden/cases/afterhours.png`.

### Dead Air

A small community radio studio after midnight, one microphone lit and the other dark while a rain-streaked window reflects an unseen listener in the street.

Save as `art/images/ink/cases/deadair.png` and `art/images/burden/cases/deadair.png`.

### The Last Route

A battered city bus stopped beneath an elevated track at 12:14 a.m., three empty seats lit inside while the route sign is deliberately unreadable and rain blurs the depot beyond.

Save as `art/images/ink/cases/lastroute.png` and `art/images/burden/cases/lastroute.png`.

### Open House

A neighbourhood youth centre gym prepared for an open house, folding chairs and donated boxes under harsh lights while a security camera points at the locked exit.

Save as `art/images/ink/cases/openhouse.png` and `art/images/burden/cases/openhouse.png`.
...
Save as `art/images/ink/signals/a-dead-scanner-channel.png` and `art/images/burden/signals/a-dead-scanner-channel.png`.
...
Save as `art/images/ink/signals/a-torn-flyer.png` and `art/images/burden/signals/a-torn-flyer.png`.
...
Save as `art/images/ink/signals/a-phone-at-one-percent.png` and `art/images/burden/signals/a-phone-at-one-percent.png`.

### 🐈 The Same Stray Cat

A wary one-eared alley cat sitting beneath the same fire escape where distant emergency light spills around a corner.

Save as `art/images/ink/signals/the-same-stray-cat.png` and `art/images/burden/signals/the-same-stray-cat.png`.
...
Save as `art/images/ink/signals/sirens-getting-closer.png` and `art/images/burden/signals/sirens-getting-closer.png`.
...
Save as `art/images/ink/signals/a-streetlight-that-wont-stay-lit.png` and `art/images/burden/signals/a-streetlight-that-wont-stay-lit.png`.
...
Save as `art/images/ink/signals/a-traffic-camera-facing-the-wrong-way.png` and `art/images/burden/signals/a-traffic-camera-facing-the-wrong-way.png`.

### ☂ An Umbrella, Inside Out

A black umbrella blown inside out and abandoned upright on a stoop despite perfectly still rain.

Save as `art/images/ink/signals/an-umbrella-inside-out.png` and `art/images/burden/signals/an-umbrella-inside-out.png`.
...
Save as `art/images/ink/signals/a-key-that-fits-nothing-you-own.png` and `art/images/burden/signals/a-key-that-fits-nothing-you-own.png`.
...
Save as `art/images/ink/signals/yesterdays-front-page.png` and `art/images/burden/signals/yesterdays-front-page.png`.

### 🩹 A Bandage, Already Bled Through

A hastily wrapped hand resting on a sink edge, white gauze already dark with blood but no wound shown.

Save as `art/images/ink/signals/a-bandage-already-bled-through.png` and `art/images/burden/signals/a-bandage-already-bled-through.png`.
...
Save as `art/images/ink/signals/a-manhole-cover-slightly-askew.png` and `art/images/burden/signals/a-manhole-cover-slightly-askew.png`.
...
Save as `art/images/ink/signals/a-stopwatch-still-running.png` and `art/images/burden/signals/a-stopwatch-still-running.png`.
...
Save as `art/images/ink/signals/a-costume-piece-not-yours.png` and `art/images/burden/signals/a-costume-piece-not-yours.png`.

### 🚂 The El, Running Late

An empty elevated-train platform after midnight, arrival clock unreadable, tunnel lights visible but never moving closer.

Save as `art/images/ink/signals/the-el-running-late.png` and `art/images/burden/signals/the-el-running-late.png`.
...
Save as `art/images/ink/signals/a-flock-of-pigeons-all-at-once.png` and `art/images/burden/signals/a-flock-of-pigeons-all-at-once.png`.
...
Save as `art/images/ink/signals/a-chalk-mark-under-fresh-paint.png` and `art/images/burden/signals/a-chalk-mark-under-fresh-paint.png`.
...
Save as `art/images/ink/signals/a-bus-transfer-for-a-dead-route.png` and `art/images/burden/signals/a-bus-transfer-for-a-dead-route.png`.
...
Save as `art/images/ink/signals/police-tape-cut-clean.png` and `art/images/burden/signals/police-tape-cut-clean.png`.
...
Save as `art/images/ink/signals/a-voicemail-with-no-voice.png` and `art/images/burden/signals/a-voicemail-with-no-voice.png`.

### 👣 One Wet Footprint

One rain-wet shoe print centered on a dry apartment hallway floor, with no other tracks in either direction.

Save as `art/images/ink/signals/one-wet-footprint.png` and `art/images/burden/signals/one-wet-footprint.png`.
...
Save as `art/images/ink/signals/a-matchbook-from-a-closed-club.png` and `art/images/burden/signals/a-matchbook-from-a-closed-club.png`.
...
Save as `art/images/ink/signals/a-prescription-bottle-wrong-name.png` and `art/images/burden/signals/a-prescription-bottle-wrong-name.png`.

### ↕ An Elevator Between Floors

Old elevator doors opened onto a solid brick wall, one brick displaced inward as if something knocked from behind it.

Save as `art/images/ink/signals/an-elevator-between-floors.png` and `art/images/burden/signals/an-elevator-between-floors.png`.

### ⛓ A Broken Zip Tie

A snapped black zip tie on a concrete floor, broken outward with a single dark hair caught in its teeth.

Save as `art/images/ink/signals/a-broken-zip-tie.png` and `art/images/burden/signals/a-broken-zip-tie.png`.

### 🧱 Fresh Concrete, Still Warm

A rectangle of new concrete steaming faintly in an old basement floor, one handprint beginning to rise instead of sink.

Save as `art/images/ink/signals/fresh-concrete-still-warm.png` and `art/images/burden/signals/fresh-concrete-still-warm.png`.
...
Save as `art/images/ink/signals/a-payphone-ringing-once.png` and `art/images/burden/signals/a-payphone-ringing-once.png`.
...
Save as `art/images/ink/signals/a-grocery-receipt-at-3-17-am.png` and `art/images/burden/signals/a-grocery-receipt-at-3-17-am.png`.
...
Save as `art/images/ink/signals/blue-thread-on-a-fire-escape.png` and `art/images/burden/signals/blue-thread-on-a-fire-escape.png`.
...
Save as `art/images/ink/signals/an-apartment-light-blinking-in-code.png` and `art/images/burden/signals/an-apartment-light-blinking-in-code.png`.
...
Save as `art/images/ink/signals/two-identical-license-plates.png` and `art/images/burden/signals/two-identical-license-plates.png`.
...
Save as `art/images/ink/signals/a-childs-drawing-of-the-block.png` and `art/images/burden/signals/a-childs-drawing-of-the-block.png`.
...
Save as `art/images/ink/threats/toll.png` and `art/images/burden/threats/toll.png`.
...
Save as `art/images/ink/threats/casting.png` and `art/images/burden/threats/casting.png`.
...
Save as `art/images/ink/threats/renovation.png` and `art/images/burden/threats/renovation.png`.
...
Save as `art/images/ink/threats/lastcall.png` and `art/images/burden/threats/lastcall.png`.
...
Save as `art/images/ink/threats/afterhours.png` and `art/images/burden/threats/afterhours.png`.
...
Save as `art/images/ink/threats/deadair.png` and `art/images/burden/threats/deadair.png`.
...
Save as `art/images/ink/threats/lastroute.png` and `art/images/burden/threats/lastroute.png`.
...
Save as `art/images/ink/threats/openhouse.png` and `art/images/burden/threats/openhouse.png`.
